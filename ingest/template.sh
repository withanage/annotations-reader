 ...
 curl -X POST -H "Content-Type: application/rdf+ldpath" --data-binary "@post.txt" "http://localhost:8080/fedora/rest/fedora:system/fedora:transform/fedora:ldpath/test{$1}/nt:base/fcr:content" 
