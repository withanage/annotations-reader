...
curl -X PUT -H "Content-Type: text/turtle" --data-binary "@open_object.ttl" "http://pers31.ub.uni-heidelberg.de:8080/fedora/fedora/rest/de/uni-heidelberg/ub/digi/diglit/lehmann1756/0001/$i"   
...
#curl -X PUT -H "Content-Type: application/ld+json" --data-binary "@rdf.json" "http://pers31.ub.uni-heidelberg.de:8080/fedora/rest/de/uni-heidelberg/ub/digi/diglit/lehmann1756/0005/$i"   
done
