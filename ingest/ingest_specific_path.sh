...
#curl -X PUT  -H "Content-Type:application/ld+json" --data-binary "@get_json.json"  "http://pers31.ub.uni-heidelberg.de:8080/fedora/rest/de/uni-heidelberg/ub/digi/diglit/lehmann1756/1/$i"  
